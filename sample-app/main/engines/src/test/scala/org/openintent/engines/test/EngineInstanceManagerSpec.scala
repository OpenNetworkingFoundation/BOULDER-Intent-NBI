...
class EngineManagerSpec extends FlatSpec with ShouldMatchersForJUnit with BeforeAndAfterAll {

  "The EngineInstanceManager" should "be initialized with configuration on startup" in (pending)
