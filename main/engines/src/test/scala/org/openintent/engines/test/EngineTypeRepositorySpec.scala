...
class EngineTypeStorageSpec extends FlatSpec with ShouldMatchersForJUnit with BeforeAndAfterAll {

  "The EngineTypeRepository" should "Save the EngineType to the Couchdb Database" in (pending)

  it should "Load an EngineType when receiving the LoadEngineType message" in (pending)
