...
class EngineModuleSpec extends FlatSpec with ShouldMatchersForJUnit with BeforeAndAfterAll {

  "The Kernel" should "be initialized with configuration on startup" in (pending)
